...
def traiter_donnees(df_annuaire, df_gestcom, df_jalixe):
    try:
        ...
        # Filtrer GESTCOM sur AR_REF = NOTE
        ...
        # Concaténer tous les titres uniques par client
        df_final_grouped = (
...
st.sidebar.markdown("---")
st.sidebar.info("✨ Développé par Chaymae Taj 🌸 — Version DAF validée Sandrine")
